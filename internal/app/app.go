...
func (m *Model) registerCommands() {
	...
	m.commands.Register(commands.Command{ID: "sync-now", Title: "Sync Now", Description: "Manually sync saved and read articles", Keywords: []string{"sync", "git", "saved", "read"}, Order: 88, Run: func() tea.Cmd { return func() tea.Msg { return syncNowMsg{} } }})
	m.commands.Register(commands.Command{ID: "setup-sync", Title: "Setup Sync", Description: "Configure Git sync settings", Keywords: []string{"sync", "git", "remote", "setup", "config"}, Order: 89})
